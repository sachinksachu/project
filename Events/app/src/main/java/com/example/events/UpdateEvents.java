...
public class UpdateEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        event_id_intent = i.getStringExtra("event_id");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new UpdateEvents.get(getApplicationContext()).execute();
        ...
        myAdapter = new SimpleCursorAdapter(UpdateEvents.this, android.R.layout.simple_spinner_dropdown_item, null, from, to, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
        new UpdateEvents.AsyncFetch(UpdateEvents.this).execute();

        SearchManager searchManager = (SearchManager) UpdateEvents.this.getSystemService(Context.SEARCH_SERVICE);


        searchView.setSearchableInfo(searchManager.getSearchableInfo(UpdateEvents.this.getComponentName()));
    ...
    class get extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            try {
                ...
                url="http://192.168.7.122/updateEvents.php";
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(UpdateEvents.this);
        HttpURLConnection conn;
        URL url = null;

        public AsyncFetch(UpdateEvents add_events) {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    Toast.makeText(UpdateEvents.this, result, Toast.LENGTH_LONG).show();
                }
